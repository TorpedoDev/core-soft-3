                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('service.store') }}" class="forms-sample"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description_ar" placeholder="{{ __('custom.description_ar') }}" cols="30" rows="10"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description_en" placeholder="{{ __('custom.description_en') }}" cols="30" rows="10"></textarea>
