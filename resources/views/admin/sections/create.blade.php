                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-description">
                                {{ __('custom.create section') }}
                            </p>
                            <form method="POST" action="{{ route('section.store') }}" class="forms-sample"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="exampleInputUsername1">{{ __('custom.title_ar') }}</label>
                                    <input type="text" name="title_ar" class="form-control"
                                        placeholder="{{ __('custom.title_ar') }}">
                                    @error('title_ar')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title_en" class="form-control"
                                        placeholder="{{ __('custom.title_en') }}">
                                    @error('title_en')
                                        <div class="text-danger"> {{ $message }} </div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputUsername1">{{ __('custom.about_ar') }}</label>
                                        <textarea placeholder="{{ __('custom.about_ar') }}" class="form-control" name="about_ar"  cols="30" rows="10"></textarea>
                                    @error('about_ar')
                                        <div class="text-danger"> {{ $message }} </div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="{{ __('custom.about_en') }}" class="form-control" name="about_en"  cols="30" rows="10"></textarea>
