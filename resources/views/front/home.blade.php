...
@foreach ($sections as $section )
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="" class="stretched-link">{{$section->title_ar}}</a></h4>
            </div>
          </div><!--End Icon Box -->
@endforeach
          ...
          <div class="col-lg-6">
            <div class="content ps-0 ps-lg-5">
              ...
              <div class="position-relative mt-4">
                <img src="{{ asset('images/'.$about->video_image) }}" class="img-fluid rounded-4" alt="">
      ...
      <div class="container" data-aos="zoom-out">
        ...
        <div class="clients-slider swiper">
          <div class="swiper-wrapper align-items-center">
            ...
            <div class="swiper-slide"><img src="{{ asset('images/'. $tech->logo) }}" class="img-fluid" alt=""></div>
            @endforeach
...
@foreach ($mobile as $mob )    
            <div class="col-xl-4 col-md-6 portfolio-item filter-mobile">
              <div class="portfolio-wrap">
                <a href="{{ asset('images/'.$mob->image) }}" data-gallery="portfolio-gallery-app" class="glightbox"><img src="{{ asset('images/'.$mob->image) }}" class="img-fluid" alt=""></a>
...
@foreach ($web as $w)    
            <div class="col-xl-4 col-md-6 portfolio-item filter-web">
              <div class="portfolio-wrap">
                <a href="{{ asset('images/'.$w->image) }}" data-gallery="portfolio-gallery-app" class="glightbox"><img src="{{ asset('images/'.$w->image) }}" class="img-fluid" alt=""></a>
                <div class="portfolio-info">
                  <h4><a href="portfolio-details.html" title="More Details">
                    @if (app()->getLocale() == 'en')
                    {{$w->name_en}}
...
@foreach ( $members as $member )  
          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="member">
              <img src="{{ $member->image != null ? asset('images/'.$member->image) : asset('images/avatar.png') }}" class="img-fluid" alt="">
              <h4>
                @if (app()->getLocale() == 'en')
                    {{$member->name_en}}
                    @else
          ...
          <div class="col-lg-4">
            ...
            <div class="info-container d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="info-item d-flex">
                ...
                <div>
                  <h4>Email:</h4>
                  <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2a43444c456a4f524b475a464f04494547">[email&#160;protected]</a></p>
                </div>
              </div><!-- End Info Item -->
